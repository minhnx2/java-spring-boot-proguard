...
public class Flight {
	...
	public Flight(boolean c, int oldE, int oldB, int oldF, int oldT, String flightName, ArrayList<Seat> seats, int totalSeats, int currentSeats, String departureCity, String arrivalCity,
			Date departureDate, Date arrivalDate, int economySeats, int bSeats, int firstSeats) {
		isChanged = c;
