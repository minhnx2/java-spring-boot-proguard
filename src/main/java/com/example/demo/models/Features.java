...
public class Features {
	...
	public Features(int price, int newPrice, int t, boolean c, double sp, double sw, double newSp, double newSw, String vt, String newVt, String st, String newSt, String pt, String newPt, String w,
			String newW, String sf, String newSf) {
		this.price = price;
